...
.kiro の要件と設計から、依存関係と検証条件を持つ実装タスクを生成・更新する。
...
```text
$kiro-spec-tasks notifications 承認済みの要件・設計から検証可能なタスクを作ってください。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-spec-tasks/SKILL.md)
