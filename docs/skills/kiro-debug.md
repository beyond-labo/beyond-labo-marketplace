...
.kiro の仕様駆動開発で、実装・検証失敗の原因を調べ、根拠のある修正と再検証を決める。原因不明の失敗や繰り返すレビュー指摘に使う。
...
```text
$kiro-debug notifications このテスト失敗の原因を調べ、最小の修正案と再検証方法を示してください。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-debug/SKILL.md)
