...
単一の .kiro 仕様の要件・設計・タスクを必要な段階から連続生成する。--auto または既存の一括許可の範囲で承認を反映する。
...
```text
$kiro-spec-quick notifications --auto 決定済みの範囲で要件・設計・タスクを生成してください。実装はまだ行いません。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-spec-quick/SKILL.md)
