...
description: .kiro の仕様駆動開発で、API、テスト、セキュリティなど特定領域のプロジェクト方針を作成または更新する。
---

配布リソースと既存設定の扱いは [利用環境](../kiro-spec-sync/references/setup.md) に従う。

# 領域別の方針

[rules/steering-principles.md](../kiro-steering/rules/steering-principles.md) と [kiro-spec-sync](../kiro-spec-sync/SKILL.md) に従う。
