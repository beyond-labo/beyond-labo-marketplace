...
.kiro の roadmap にある複数仕様を依存順に生成・更新する。仕様間レビューと共有索引の更新を統括する。
...
```text
$kiro-spec-batch --auto roadmap の新規仕様一覧を依存順に生成し、仕様間の契約を確認してください。実装はまだ行いません。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-spec-batch/SKILL.md)
