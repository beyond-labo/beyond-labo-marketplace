...
.kiro の仕様駆動開発で、現行の要件と既存コードの差分を調べ、実装方針を選ぶための根拠を記録する。
...
```text
$kiro-validate-gap notifications 要件と現行コードの差分を調べ、research に設計の根拠を記録してください。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-validate-gap/SKILL.md)
