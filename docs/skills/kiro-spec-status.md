...
.kiro の仕様駆動開発で、仕様の生成、承認、実装進捗と文書の同期状態を読み取り専用で確認する。
...
```text
$kiro-spec-status notifications 生成・承認・同期・実装進捗を区別して報告してください。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-spec-status/SKILL.md)
