...
- **Use available web search tools** to find:
...
- **Use available page reading tools** to analyze:
...
2. Verify claims against version-matched official documentation and source code
3. Investigate relevant open-source implementations when they resolve uncertainty
