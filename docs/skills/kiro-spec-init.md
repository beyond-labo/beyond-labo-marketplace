...
.kiro に新しい機能仕様の制御 JSON と要件の雛形を作る。既存仕様の更新には sync を使う。
...
```text
$kiro-spec-init 通知設定の仕様を初期化してください。対象はメール通知の有効・無効の切り替えです。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-spec-init/SKILL.md)
