...
.kiro の仕様駆動開発で、API、テスト、セキュリティなど特定領域のプロジェクト方針を作成または更新する。
...
```text
$kiro-steering-custom 既存の API 方針を調べ、採用済みのエラー形式へ更新してください。
```
...
[SKILL.md](https://github.com/beyond-labo/beyond-labo-marketplace/blob/main/plugins/okf-sdd/skills/kiro-steering-custom/SKILL.md)
